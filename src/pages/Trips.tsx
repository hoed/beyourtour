...
const Trips = () => {
  const trips = [
    ...
    },
    {
      ...
      description: "Early morning visit to Borobudur temple for sunrise, followed by temple exploration and local village tour.",
      image: heroCentralJava,
      duration: "1 Day",
    ...
    },
    {
      ...
      description: "Discover West Java's natural beauty with visits to Tangkuban Perahu volcano, Ciater hot springs, and scenic tea plantations.",
      image: heroWestJava,
      duration: "2 Days / 1 Night",
      groupSize: "2-15 people",
      location: "West Java",
    ...
    },
    {
      ...
      description: "Explore working tea and coffee plantations in the cool highlands, learn about production, and enjoy tastings with panoramic views.",
      image: heroWestJava,
      duration: "3 Days / 2 Nights",
    ...
    {
      title: "Culinary & Culture Tour",
      description: "Food lover's journey featuring cooking classes, market visits, traditional meals, and cultural performances in Yogyakarta and Solo.",
      image: gallery3,
    ...
    },
    {
      ...
      description: "Specialized tour for photographers with optimal timing for landscapes, cultural events, and portrait opportunities at iconic locations.",
      image: gallery1,
      duration: "5 Days / 4 Nights",
    ...
    {
      title: "Nature & Wildlife Trek",
      description: "Explore Java's national parks, waterfalls, and wildlife habitats with hiking, birdwatching, and nature photography opportunities.",
      image: gallery1,
      duration: "4 Days / 3 Nights",
      groupSize: "2-10 people",
      location: "East & West Java",
      price: "From $450",
    },
  ];
